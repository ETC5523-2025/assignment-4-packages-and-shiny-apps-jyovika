...
Tools and an interactive app to explore **healthcare-associated infection (HAI)** data derived from the BHAI package.  
...
[Summarising HAI data](articles/summarising-hai.html)
[Visualising totals with `plot_hai_totals()`](articles/visualising-hai-totals.html)
...
## 🔗 Useful links
 ...
 - Website: https://ETC5523-2025.github.io/assignment-4-packages-and-shiny-apps-jyovika

- Source code: [GitHub Repository](https://github.com/ETC5523-2025/assignment-4-packages-and-shiny-apps-jyovika)

- Report an issue: [Submit here](https://github.com/ETC5523-2025/assignment-4-packages-and-shiny-apps-jyovika/issues)
